...
class AbsenceService
{
    ...
    /**
     * Récupérer toutes les absences avec les relations nécessaires
     */
    public function getAllAbsencesWithRelations()
    {
        return Absence::with(['eleve.user'])->get();
    }

    /**
     * Récupérer une absence par son ID avec les relations nécessaires
     */
    public function getAbsenceByIdWithRelations($id)
    {
        return Absence::with(['eleve.user'])->find($id);
    }
    ...
    /**
     * Récupérer les absences d'un élève avec les relations nécessaires
     */
    public function getAbsencesByEleveIdWithRelations($eleveId)
    {
        return Absence::where('eleve_id', $eleveId)
            ->with(['eleve.user'])
