...
Route::middleware(['auth:api'])->group(function () {
    // Route d'inscription (seul un admin pourra l'utiliser)
    ...
    Route::get('/bulletins/{id}/download', [BulletinController::class, 'downloadPDF']);
    Route::post('/bulletins/download-class', [BulletinController::class, 'downloadClassBulletins']);
